...
//指定编译器需要的代码块内容
//目前只支持，Generic,UIDInstance,ServiceProvider
    ...
    switch ( method ){
        ...
        case "ServiceProvider" :
            ...
            if( !express.ServiceProviderValue )
            {
                ...
                //去掉参数类型
                express.ServiceProviderValue = param[0].replace(/{([a-z]+[\w]+)(\s*\:\s*[a-z]+[\w]+)?}/ig,"{$1}");
                desc.thisArg='"'+ express.ServiceProviderValue+'"';

                var ServiceProviderList = globalsConfig.ServiceProviderList || (globalsConfig.ServiceProviderList = {});
                ...
                if (!ServiceProviderList[key]) {
                    ...
                    ServiceProviderList[key] = {
                        "name": param[0],
                        "bind":express.ServiceProviderValue,
                        "provider": provider[0],
                        "action": provider[1],
                        "method": method
                    }
