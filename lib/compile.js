...
function getDescriptorOfExpression(it, classmodule)
{
    ...
    var isstatic = it.current.value === type || type==='Class' || (desc && desc.id==='object') || property.thisArg ==="System";
...
function buildModule(syntax, o , config, force )
{
    ...
    for (var i in o.import)
    {
        ...
        {
            importMap[i] = buildSyntax.formatImportClassPath( o.import[i], importModule );
        }
    }
