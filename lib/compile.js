...
{
    var infor=false;
    var isIterator = isIteratorInterface( this.module );
    ...
    if( infor )
    {
        ...
        this.content.push({
            name:[],
            descriptor:null,
            thisArg:buildSyntax.getForIn( parse( this.module, property), name,  itn , this.module, isIterator ),
            expression:false,
            before:[],
            after:'',
            "super":null,
...
Iteration.prototype.nextOf=function(stack)
{
    ...
    this.content.push({
        name:[],
        descriptor:null,
        thisArg:buildSyntax.getForInOf( parse( this.module, property), name, itn, this.module, isIterator ),
        expression:false,
        before:[],
        after:'',
        "super":null,
