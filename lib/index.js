...
function make( config , doneCallback)
{
    ...
    if( descriptions.length > 0 )
    {
        ...
        var prom = new Promise(function (resovle, reject)
        {
            var only_current = config.only_current_syntax===true || config.service_provider_syntax ==="none";
            try{
                SyntaxBuilder[ config.syntax ]( config , descriptions, default_bootstrap_class[0], only_current , resovle, reject, completed);
            }catch(e){
                reject(e);
            }
