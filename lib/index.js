...
const SyntaxBuilder={
    ...
    'javascript':function(config, descriptions, default_bootstrap_class, onlyClient, resovle, reject, doneCallback )
    {
        ...
        {
            const dependencies = jsBuilder.getDependencies( config, descriptions );
            ...
            {
                resovle();
                isCallback && doneCallback( dependencies );
            }
            ...
            const makeService = ()=>{
                ...
                if( onlyClient !== true )
                {
                    ...
                    descriptions.forEach( (module)=>{
                        const modules = jsBuilder.getAllModules(config, module, null, null, "javascript" );
                        const usedModules = jsBuilder.getUsedModules( modules, "javascript" );
