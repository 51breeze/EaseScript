            ...
            if( parameters[i] === undefined )
            {
                ...
                if( desc.__stack__ instanceof Ruler.STACK )
                {
                    ...
                    if( viewMetaType && type==="es.core.View" )
                    {
                        ...
                        parameters.push("new "+viewClass+".constructor( this )");
                        continue;
                    }
                }
...
function operateMethodOfGet(classmodule, thisvrg, desc, props ,info, before)
{
    ...
    props = createReferenceProps( props,  (checkRunning || !desc.descriptor) );
            ...
            if( item.keyword() === 'function' )
            {
                ...
                if( item.name() === stack.name() && !isstatic )
                {
                    ...
                    item.addListener("(iterationDone)",function (e) {
                        e.content.splice(2,1,"constructor");
...
function makeClassModule( o , config)
{
    ...
    if( o.inherit && o.id !== "namespace" )
    {
        ...
        if( inheritClass.nonglobal===true )
        {
            ...
            {
                internalCode = "var "+inheritClass.classname+"="+makeClassModule( inheritClass , config);
            }else{
    ...
    if( o.id==="namespace" )
    {
        ...
        for( var n in o.namespaces )
        {
            ...
            o.makeContent += config.context.defineModuleMethod + "(" + JSON.stringify(values) + ", " + v + ");\n";
        }
        return str;
    }
    ...
    if( !o.isInternal )
    {
        o.makeContent = config.context.defineModuleMethod+"("+JSON.stringify(import_values)+","+str+");\n";
