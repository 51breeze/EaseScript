    ...
    switch ( metatype.type )
    {
        ...
        case 'Bindable' :
            ...
            if( item.id==='var' )
            {
                ...
                item.value = {
                    "set":{
                        'id':'function',"privilege":"public","bindable":true,"type":"void",'isAccessor':true,'varToBindable':true, "value":setter.join(""),
                    },
                    "get":{
                        'id':'function',"privilege":"public","bindable":true,"type":type,'isAccessor':true,'varToBindable':true, "value":getter.join(""),
                    }
                }
            }
            item.bindable = true;
