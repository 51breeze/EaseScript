            ...
            if( syntaxMetatype.length > 1 )
            {
                syntaxMetatype.forEach(function (a)
                {
                    syntaxs.forEach(function (b)
                    {
                         ...
                         {
                             throw new Error('Metatype binding has already exists in same object for "'+metatype.type+'('+metatype.param.source+')"');
                         }
                    });
                });
            }
