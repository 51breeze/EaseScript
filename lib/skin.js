        ...
        for (var i in nodes) 
        {
           ...
           if( child && typeof child === "string" && !skinObject.isMetadata )
           {
                ...
                }else
                {
                    ...
                    child.ownerRenderComponent=  !!(skinObject && parent && parent.ownerRenderComponent);
...
function makeClientScript( classModule , skinObject , isMakeView )
{
    ...
    {
        body.push(`\nSystem.hotUpdate( this, function(obj:${classModule.classname}, newClass:Class ){

            if( obj instanceof es.core.View ){
                (obj.hostComponent as es.core.Application).render( new newClass(obj.hostComponent) );
                return true;
            }else if( (obj.hostComponent as es.components.SkinComponent).skinClass !== newClass )
            {
                (obj.hostComponent as es.components.SkinComponent).skinClass = newClass;
                return true;
            }
            return false;
   ...
   if( classModule.fullclassname==="view.Home" )
    {
         //console.log(content.join(""));
        // process.exit();
    }
