            ...
            if( child )
            {
                ...
                if( textBinding !== true )
                {
                    ...
                    if( child.async ===true && child.isSkinComponent )
                    {
                        ...
                        {
                            skinObject.attributeId = "SID-"+uid(context);
                        }
...
function getServerComponentProperties(classModule, isMakeView, component, imports, loaded, body, property, newInstances, invokeContents , clientInitComponents, clientPullDataHandle )
{
   ...
   if( isMakeView === true ){
    ...
    Utils.forEach(components, function ( component )
    {
       ...
       if( component.async )
       {
           ...
           getServerComponentProperties(classModule, false, component, imports, loaded,
               ...
               clientScript.newInstances, clientScript.body , null, clientPullDataHandle);

       }else
       {
           getServerComponentProperties(classModule, isMakeView , component, imports, loaded, body, property, newInstances, invokeContents , clientInitComponents , clientPullDataHandle);
       }
    ...
    if ( isMakeView=== true)
    {
         ...
         if( isClientSupport )
         {
             ...
             {
                clientBody.splice(1,0,clientPullDataGetInstance,clientPullData.join(""));
             }
