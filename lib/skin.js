...
function makeScript( classModule , skinObject , isMakeView )
{
    ...
    if( skinObject.metadataList && skinObject.metadataList.HostComponent )
    {
        ...
        property.push( "override protected function get hostComponent():Object{\nreturn this._hostComponent;\n}\n");
    }
    ...
    var elem = `
    var async:Boolean = hostComponent is SkinComponent ? (hostComponent as SkinComponent).async : false;
    var elem:Object = !async ? this.findElement(0) : null;`;

    var initContent = body.join("");
    var superValue = `super(${name});\n`;
    var superClientValue = `super( elem ? elem : ${name});`;
    var initProperties = `elem ? this.__$initClientProps() : this.__$initOriginProps();`;
    ...
    if ( isMakeView === true)
    {
        ...
        elem = "";
        initProperties = "this.__$initClientProps();";
    }
...
function makeRenderScript(skin, context, parent, topScope, forLevel, keyPrefix, container)
{
    ...
    const uniqueKey = global_total_count;
    ...
    //一个组件或者是元素
        ...
        else if( skin.isComponent )
        {
            ...
            if( skin.isDisplayElement )
            {
                ...
                newClientValue =  skin.ownerForeachCommand ? DOMRender+".findComponent("+param.slice(1,2).join(",")+",true)" : DOMRender+".findComponent("+param.slice(1,2).join(",")+")";
