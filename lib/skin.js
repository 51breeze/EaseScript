...
function getServerComponentProperties(classModule, isMakeView, isClientSupport, component, imports, loaded, body, property, newInstances,declaration, invokeContents , clientInitComponents, synchSkinProperties )
{
    ...
    } else
    {
        ...
        {
            var componentId = isMakeView ? '"'+Utils.uid()+'"' : "hostComponent.getComponentId('"+component.id+"')";
...
function makeServerScript( classModule , skinObject , isMakeView )
{
   ...
   if( classModule.isMakeView )
   {
    ...
    var clientPullContent = 'var '+clientPullHander+':Object=Interaction.pull(hostComponent.getComponentId());\n';
    ...
    if ( isMakeView=== true)
    {
       ...
       if( isClientSupport )
       {
           serverPushSkinProperties = 'Interaction.push("' + classModule.fullclassname + '",{' + serverPushSkinProperties.join(",\n") + '});\n';
           body.push( serverPushSkinProperties );
       }
         ...
         if( isClientSupport )
         {
             clientPullContent = 'var '+clientPullHander+':Object=Interaction.pull("'+classModule.fullclassname+'");\n';
             var clientBody = [
                 "super("+paramName+");\n",
    ...
    } else
    {
        ...
        if( isClientSupport )
        {
            serverPushSkinProperties  = 'Interaction.push(hostComponent.getComponentId(),{'+serverPushSkinProperties.join(",\n")+'});\n';
