...
function parseSkin(elem, context, module , parent, async, childIndexAt )
{
    ...
    }else if( !parent.ownerProperty && (parent.id || parent=== context) && !skinObject.isComponent && !skinObject.nonChild && !(parent.name =="head" || parent.name =="html") ){

        //var childStr = __toString( skinObject );
        //(context.initProperties).push( (parent.id || "this") + ".element.addChildAt(  Element.createElement('" + childStr + "')  ,"+childIndexAt+")" );
    }
