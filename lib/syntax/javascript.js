...
var syntax={
    ...
    "toForceTypeConvert":function ( value , type , desc, classmodule )
    {
        ...
        {
            valuetype = !(desc.descriptor.type === "*" || desc.descriptor.type === "void") ? desc.descriptor.type : null;
        }
        if( numberType.indexOf( type.toLowerCase() ) >=0 )
        {
            if ( valuetype && numberType.indexOf( valuetype.toLowerCase() ) >= 0 )return value;
