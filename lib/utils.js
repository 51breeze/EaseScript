...
function parseMetaEmbed(metatype, config, relative )
{
    var source = metatype.param.source;
    if( relative ){
        source = relative+source;
    }
    return copyfileToBuildDir(source, utils.getBuildPath(config, 'build'), config );
}
...
utils.globals = ['Object','Function','Array','String','Number','Boolean','Math','Date','RegExp','Error','ReferenceError','TypeError','SyntaxError','JSON','Reflect','Symbol','console'];
