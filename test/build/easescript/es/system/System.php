...
use es\system\Document;
use es\system\Window;
...
define('NaN','NaN');
define('ES_BUILD_APPLICATION_NAME','easescript');
define('ES_BUILD_LIBARAY_NAME','es');
define('ES_BUILD_SYSTEM_PATH','es\system');
