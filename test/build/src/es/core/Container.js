...
var proto={"constructor":{"value":Container},"T8__children":{"writable":true,"value":new Array()}
...
,"_addChildAt":{"value":function addChildAt(child,index){
	...
	(Reflect.type(child,Display)).Set_P7_displayParent(this);
	return child;
}}
,"_removeChild":{"value":function removeChild(child){
	...
	if(child){
		...
		(Reflect.type(child,Display)).Set_P7_displayParent(null);
