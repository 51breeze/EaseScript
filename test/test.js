...
const builder = require("./javascript/builder");
const fs = require("fs");
...
const basedir = path.resolve("d:/workspace/EaseScript");
loader = path.resolve(basedir,'lib/loader.js');

const lessOptions = {
  globalVars:builder.getLessVariables( esConfig ),
  paths:[
...
const config = {
  ...
  entry:{
   ...
   // 'person': path.resolve(__dirname,'main2.js'),
